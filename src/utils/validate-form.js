...
const validationMessages = {
  empty: (field) => `Porfavor ingrese ${field}`,
  short: (field) => `${field} Es muy corta!`,
  invalid: (field) => `Porfavor intente nuevamente ${field}`,
  insecurePass: "Contraseña insegura",
  shortPass: "Contraseña debe tener min. 8 caracteres",
  shortText: "El mensaje es muy corto",
  matchPass: "Contraseñas no coinciden",
  spacedPass: "Contraseña no debe contener espacios",
};

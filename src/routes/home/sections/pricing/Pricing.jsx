  ...
  return (
    <motion.section
      ...
      <p className="section-description">
        Explora nuestra variedad de opciones de menu, desde pizzas clasicas hasta platos especiales y deliciosos postres. Cada plato esta elaborado con ingredientes frescos y de alta calidad para ofrecerte una experiencia culinaria inigualable.
      </p>

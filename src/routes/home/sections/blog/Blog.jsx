...
const Blog = () => {
  return (
    <motion.section
      ...
      <h2 className="txt-center pop-font txt-white">Recientes</h2>
      <p className="section-description">
        Fresco desde el horno! Mantente al dia con las ultimas noticias, consejos y recetas de pizza en nuestro blog. Descubre nuevas ideas para tus comidas y aprende mas sobre el arte de hacer pizza.
      </p>
